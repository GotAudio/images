# -*- coding: utf-8 -*-
"""Kagle 24_tutorial.siamese.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1YliEZj6tsXAymaGWj-BF6JNuOHQ2hlvA
"""
...
path = untar_data("https://github.com/GotAudio/images/raw/master/images.tar.gz") 
...
class SiameseTransform(Transform):
    def __init__(self, files, splits):
        self.lbl2files = [{l: [f for f in files[splits[i]] if label_func(f) == l] for l in labels} for i in range(2)]
        self.valid = {f: self._draw(f,1) for f in files[splits[1]]}
    def encodes(self, f):
        f2,same = self.valid.get(f, self._draw(f,0))
        img1,img2 = PILImage.create(f),PILImage.create(f2)
...
x = [v for v in valids if v in files[splits[0]]]
x
